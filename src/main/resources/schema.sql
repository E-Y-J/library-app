...
CREATE TABLE book_copy (
	...
	CONSTRAINT fk_book_id FOREIGN KEY (id) REFERENCES book,
...
CREATE TABLE member_account (
	...
	CONSTRAINT fk_member_category_id FOREIGN KEY (id) REFERENCES member_category,
);
...
CREATE TABLE book_loan (
	...
	CONSTRAINT fk_member_id FOREIGN KEY (id) REFERENCES member_account,
	CONSTRAINT fk_book_copy_id FOREIGN KEY (id) REFERENCES book_copy,
);
