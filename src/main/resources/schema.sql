...
CREATE SEQUENCE book_reserve_sequence START WITH 1 INCREMENT BY 1 AS BIGINT;
...
CREATE TABLE book_copy (
	...
	CONSTRAINT fk_book_copy_book_id FOREIGN KEY (book_id) REFERENCES book,
...
CREATE TABLE book_reserve (
    id BIGINT GENERATED BY DEFAULT AS SEQUENCE book_reserve_sequence,
	member_id BIGINT NOT NULL,
	book_id BIGINT NOT NULL,
	CONSTRAINT pk_book_reserve_id PRIMARY KEY (id),
	CONSTRAINT fk_book_reserve_member_id FOREIGN KEY (member_id) REFERENCES member_account,
	CONSTRAINT fk_book_reserve_book_id FOREIGN KEY (book_id) REFERENCES book,
);